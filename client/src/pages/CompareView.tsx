    ...
    <div className="p-4 md:p-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mt-8 flex flex-col sm:flex-row justify-between items-center gap-4 bg-[#f8fafc] p-4 border border-[#e2e8f0]" style={{ borderRadius: '2px' }}>
          ...
          <div className="mt-10 mb-8 bg-white rounded-lg shadow-sm p-6 border border-gray-200">
            <div className="flex items-center mb-4">
              <span className="material-icons text-[#0284c7] mr-2">smart_toy</span>
              <h3 className="text-xl font-semibold">AI-Powered Comparison Assistant</h3>
            </div>
